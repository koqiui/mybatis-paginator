...
public class OrderItem implements Serializable {
	...
	public OrderItem(String property, Direction direction, String orderExpr) {
	...
	public static List<OrderItem> formString(String orderSegment) {
	 ...
	 */
	public static List<OrderItem> formString(String orderSegment, String orderExpr) {
		...
		for (int i = 0; i < orderSegments.length; i++) {
			...
			OrderItem order = _formString(sortSegment, orderExpr);
			if (order != null) {
				results.add(order);
			}
		}
	...
	private static OrderItem _formString(String orderSegment, String orderExpr) {
	...
	public static OrderItem create(String property, String direction) {
	 ...
	 * @return
	 */
	public static OrderItem create(String property, String direction, String orderExpr) {
		return new OrderItem(property, OrderItem.Direction.fromString(direction), orderExpr);
	}
