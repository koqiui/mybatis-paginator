package com.github.ext.mybatis.paginator;
...
import com.github.ext.mybatis.paginator.dialect.Dialect;
import com.github.ext.mybatis.paginator.domain.PageBounds;
import com.github.ext.mybatis.paginator.domain.PagedList;
import com.github.ext.mybatis.paginator.domain.Paginator;
import com.github.ext.mybatis.paginator.support.PropertiesHelper;
import com.github.ext.mybatis.paginator.support.SQLHelper;
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	public Object intercept(final Invocation invocation) throws Throwable {
		...
		if (pageBounds.getOffset() == RowBounds.NO_ROW_OFFSET && pageBounds.getLimit() == RowBounds.NO_ROW_LIMIT && pageBounds.getOrderItems().isEmpty()) {
		...
		if (pageBounds.isContainsTotalCount()) {
			Callable<Paginator> countTask = new Callable() {
				public Object call() throws Exception {
					...
					return new Paginator(pageBounds.getPageNumber(), pageBounds.getLimit(), count);
				}
			};
			Future<Paginator> countFutrue = call(countTask, async);
			return new PagedList(listFuture.get(), countFutrue.get());
		}
